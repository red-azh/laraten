...
<head>
    ...
    <script src="https://kit.fontawesome.com/e75c78aabd.js" crossorigin="anonymous"></script>
            ...
            <div class="sidebar-wrapper active">
                <div class="sidebar-header position-relative">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="logo">
                            <a href="{{url('/home')}}"><img src="{{asset('dist')}}/assets/compiled/svg/logo.svg"
                                    alt="Logo" srcset=""></a>
                        </div>
                    ...
                    <ul class="menu">
                        ...
                        <li class="sidebar-item  has-sub">
                            ...
                            <ul class="submenu ">
                                ...
                                <li class="submenu-item">
                                    <a href="{{route('books')}}" class="submenu-link">Manage Books</a>
                                    ...
                                    <div class="dropdown ms-auto mb-lg-0">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuButton"
                                            ...
                                            <form method="POST" action="{{ route('logout') }}">
                                                @csrf
                                                <li><a class="dropdown-item" href="{{url('/')}}" :href="route('logout')"
                                        ...
                                        <div class="card-body px-4 py-4-5">
                                            <div class="row">
                                                <div
                                                    ...
                                                    {{-- azhari juliansyah putra --}}
                                                </div>
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                    <h6 class="text-muted font-semibold">Data Kategori</h6>
                                                    <h6 class="font-extrabold mb-0">{{$buku =
                                                        DB::table('kategori')->count()}}</h6>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body px-4 py-4-5">
                                            <div class="row">
                                                ...
                                                <div class="col-md-8 col-lg-12 col-xl-12 col-xxl-7">
                                                    ...
                                                    <h6 class="font-extrabold mb-0">{{$kategori =
