                ...
                <div id="auth-left">
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="form-group position-relative has-icon-left mb-4">
                            <input type="text" class="form-control form-control-xl" placeholder="Email or Username" name="usermail"
                                value="{{old('email')}}">
                        ...
                        {{-- button --}}
                        <button class="btn btn-primary btn-block btn-lg shadow-lg mt-5" type="submit">{{ __('Log
                            in')
                            }}</button>
                    </form>
